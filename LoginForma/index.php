     ...
     <div><img class="mob3png" src="../img/mob3.png" alt=""></div>
      ...
      <div class="slideshow-container">
        ...
        <div class="mySlides">
          ...
          <img class="img9ci" src="../img/99bit.png" style="width:100%">
        </div>
        ...
        <div class="mySlides">
           ...
           <img class="img9ci" src="../img/coinBur.jpg" style="width:100%">
        </div>
        ...
        <div class="mySlides">
          ...
          <img class="img9ci" src="../img/invest.jpg" style="width:100%">
        </div>
